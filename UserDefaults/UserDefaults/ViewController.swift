...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
  ...
  override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
    ...
    ac.addAction(UIAlertAction(title: "Rename", style: .default) { _ in
      let rename = UIAlertController(title: "Change current name", message: nil, preferredStyle: .alert)
      rename.addTextField()
      
      rename.addAction(UIAlertAction(title: "Save", style: .default) { [weak self, weak rename] _ in
